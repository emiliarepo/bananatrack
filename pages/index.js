						...
						<div className="flex flex-wrap -m-4 content-start">
							<div className="p-4 w-full lg:w-1/2">
								<div className="h-full bg-white bg-opacity-75 px-8 pt-8 pb-10 rounded-lg overflow-hidden text-center relative">
									...
									<p className="font-medium">
										Banaani on yksi merkittävimmistä hedelmistä opiskelijan
										ravinnon kannalta. Se sisältää paljon elimistölle tärkeitä
										aineita kuten kuitua, B- ja C-vitamiinia, kaliumia ja
										mangaania. Banaani on myös erittäin monipuolinen hedelmä:
										siitä voi tehdä esimerkiksi lettuja, muffinseja, leipää tai
										smoothieita.
										<br />
										<br />
										Vaikka banaani onkin monia muita hedelmiä halvempi, hinnat
										vaihtelevat reilusti kaupasta toiseen. Banaanin hinta voi
										olla jopa 50% korkeampi kuin saman ketjun toisessa
										liikkeessä. Sivumme <b>reaaliaikaisen</b> tiedon ansiosta
										opiskelijat pystyvät löytämään mahdollisimman halpoja
										banaaneja.
									</p>
								</div>
							</div>
							...
							<div className="p-4 w-full lg:w-1/2">
								<div className="h-full bg-white bg-opacity-75 px-8 pt-8 pb-10 rounded-lg overflow-hidden text-center relative">
									...
									<p className="font-medium">
										Kesko ei ole vielä ymmärtänyt banaanien merkitystä
										opiskelijan ravitsemukselle. K-ryhmän banaanifoobisten
										mielipiteiden takia Kiituribot ei valitettavasti pääase
										käsiksi reaaliaikaiseen dataan, vaan data pitää hakea
										manuaalisesti tietyn ajan välein.
										<br />
										<br />
										S-ryhmän kaupat ovat tällä hetkellä siirtymässä vanhasta{" "}
										...
										määrä kasvaa joka päivä.
										<br />
										<br />
										Valitettavasti Alepat eivät tarjoa noutopalvelua, vaan
										listassa näkyy pelkästään Alepan keskusvarasto.
									</p>
								</div>
							</div>
						</div>
